...
class TestOpenAIServerWithEAGLE3AndHiddenStatesEnabled(
    ...
    def setUpClass(cls):
        ...
        cls.model = "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/LLM-Research/Llama-3.1-8B-Instruct/"
        cls.base_url = DEFAULT_URL_FOR_TEST
        cls.api_key = "sk-123456"
        cls.speculative_algorithm = "EAGLE3"
        #cls.speculative_draft_model = "jamesliu1/sglang-EAGLE3-Llama-3.1-Instruct-8B"
        cls.speculative_draft_model = "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/sglang-EAGLE3-LLaMA3.1-Instruct-8B"
        cls.process = popen_launch_server(
            cls.model,
            cls.base_url,
            timeout=DEFAULT_TIMEOUT_FOR_SERVER_LAUNCH,
