...
suite_ascend = {
    "per-commit-1-npu-a3": [
     ...
     # TestFile("ascend/test_ascend_llm_models_stablelm-2-1_6b.py", 400),
      #TestFile("ascend/test_ascend_L2_cache_TTFT.py",400),
      ...
      #TestFile("ascend/test_ascend_prefferred_sampling_params.py",400),
      #TestFile("ascend/test_ascend_tp1_bf16.py",400),
      #TestFile("ascend/test_ascend_tp4_bf16.py",400),
      #TestFile("ascend/test_create_kvindices.py",400),
      #TestFile("ascend/test_no_chunked_prefill.py",400),
      #TestFile("ascend/test_no_overlap_scheduler.py",400),
      #TestFile("ascend/test_request_length_validation.py",400),
      #TestFile("ascend/test_server_args.py",400),
      TestFile("ascend/test_vlm_models_glm_4_5v.py",400),
      TestFile("ascend/test_vlm_models_mistral-small_3_1_24b_instruct2503.py",400),
      ...
      TestFile("ascend/test_ascend_llava_1.6v_34b.py",400),
      TestFile("ascend/test_ascend_llava_next_72b.py",400),
      TestFile("ascend/test_ascend_llava_onevision_qwen2_7b_ov.py",400),
      TestFile("ascend/llm_models/test_ascend_afm_4_5b.py", 400),
      TestFile("ascend/llm_models/test_ascend_baichuan2_13b_chat.py", 400),
      TestFile("ascend/llm_models/test_ascend_c4ai_command_r_v01.py", 400),
      TestFile("ascend/llm_models/test_ascend_chatglm2_6b.py", 400),
      TestFile("ascend/llm_models/test_ascend_exaone_3.py", 400),
      TestFile("ascend/llm_models/test_ascend_gemma_3_4b_it_llm.py", 400),
      TestFile("ascend/llm_models/test_ascend_glm4_9b_chat.py", 400),
      TestFile("ascend/llm_models/test_ascend_granite_3_0_3b_a800m.py", 400),
      TestFile("ascend/llm_models/test_ascend_granite_3_1_8b.py", 400),
      TestFile("ascend/llm_models/test_ascend_internlm2_7b.py", 400),
      TestFile("ascend/llm_models/test_ascend_ling_lite.py", 400),
      TestFile("ascend/llm_models/test_ascend_llama_2_7b.py", 400),
      TestFile("ascend/llm_models/test_ascend_mimo_7b_rl.py", 400),
      TestFile("ascend/llm_models/test_ascend_mistral_7b.py", 400),
      TestFile("ascend/llm_models/test_ascend_persimmon_8b_chat.py", 400),
      TestFile("ascend/llm_models/test_ascend_phi_4_multimodal.py", 400),
      TestFile("ascend/llm_models/test_ascend_smollm_1_7b.py", 400),
      TestFile("ascend/llm_models/test_ascend_llm_models_stablelm-2-1_6b.py", 400),
      TestFile("ascend/llm_models/test_ascend_llm_models_olmoe_1b_7b.py", 400),
      #TestFile("ascend/llm_models/test_ascend_llm_models_Kimi-K2.py", 400),
      #TestFile("ascend/llm_models/test_qwen3_next_models.py", 400),
      TestFile("ascend/llm_models/test_qwen3_30B_models.py", 400),
      TestFile("ascend/test_qwen3_0_6B.py", 400),
      TestFile("ascend/llm_models/test_ascend_tp4_bf16.py", 400),
      TestFile("ascend/llm_models/test_ascend_pp_single_node.py", 400),
      #TestFile("ascend/llm_models/test_ascend_llama4_models.py", 400),
      TestFile("ascend/llm_models/test_ascend_embedding_models.py", 400), 
      TestFile("ascend/llm_models/test_ascend_llm_models_grok.py", 400),
      TestFile("ascend/llm_models/test_ascend_llm_models_XVERSE.py", 400),
      TestFile("ascend/embedding_models/test_ascend_embedding_models.py", 400),
      TestFile("ascend/embedding_models/test_ascend_embedding_models_e5.py", 400),
      #TestFile("ascend/embedding_models/test_gme_qwen_models.py", 400),
      TestFile("ascend/embedding_models/test_embedding_models_clip_vit_large_patch14_336.py", 400),
      #TestFile("ascend/rerank_models/test_ascend_cross_encoder_models.py", 400),
      TestFile("ascend/reward_models/test_ascend_reward_models.py", 400),
      TestFile("ascend/reward_models/test_ascned_llama_3_1_8b.py", 400),
      TestFile("ascend/reward_models/test_ascend_reward_internlm2_7b.py", 400),
      TestFile("ascend/reward_models/test_ascend_qwen2_5_math_rm_72b.py", 400),
      TestFile("ascend/vlm_models/test_ascend_gemma_3_4b_it.py", 400),
      TestFile("ascend/vlm_models/test_ascend_janus_pro_1b.py", 400),
      TestFile("ascend/vlm_models/test_ascend_janus_pro_7b.py", 400),
      TestFile("ascend/vlm_models/test_ascend_mimo_vl_7b_rl.py", 400),
      TestFile("ascend/vlm_models/test_ascend_minicpm_o_2_6.py", 400),
      TestFile("ascend/vlm_models/test_ascend_minicpm_v_2_6.py", 400),
      TestFile("ascend/vlm_models/test_ascend_phi4_multimodal_instruct.py", 400),
      TestFile("ascend/vlm_models/test_ascend_qwen2_5_vl_3b_instruct.py", 400),
      TestFile("ascend/vlm_models/test_ascend_deepseek_vl2.py", 400),
      TestFile("ascend/vlm_models/test_vlm_models_mistral-small_3_1_24b_instruct2503.py", 400),
      TestFile("ascend/vlm_models/test_vlm_models_glm_4_5v.py", 400),
      TestFile("ascend/vlm_models/test_ascend_qwen3_vl_235.py", 400),
     ...
     # TestFile("ascend/neiyuan/test_ascend_weight_loader_disable_mmap.py", 400),
      ...
      TestFile("ascend/need/test_ascend_L1_cache_input_text_different.py",400),
      TestFile("ascend/need/test_ascend_L1_cache_input_text_short.py",400),
      TestFile("ascend/need/test_ascend_L1_cache_resused.py",400),
      TestFile("ascend/need/test_ascend_L2_cache_input_text_different.py",400),
      TestFile("ascend/need/test_ascend_L2_cache_input_text_short.py",400),
      TestFile("ascend/need/test_ascend_L2_cache_mutually_exclusive.py",400),
      TestFile("ascend/need/test_ascend_L2_cache_resused.py",400),
      TestFile("ascend/need/test_ascend_L2_cache_TTFT.py",400),
      TestFile("ascend/test_ascend_Qwen2.5_1.5B_apeach.py",400),
      #TestFile("ascend/test_ascend_qwen2_5_math_rm_72b.py",400),
      #TestFile("ascend/test_ascend_reward_internlm2_7b.py",400),
    ],
    "per-commit-2-npu-a3": [
       # TestFile("ascend/test_ascend_graph_tp2_bf16.py", 400),
    ],
