...
USE_VLLM_CUSTOM_ALLREDUCE=1 python -m sglang.launch_server --model-path /home/hexq/weight --disaggregation-ib-device mlx5_0,mlx5_1 --disaggregation-mode prefill --host 192.168.0.60 --port 8000 --trust-remote-code --tp-size 16 --dp-size 2 --enable-dp-attention --mem-fraction-static 0.7 --attention-backend ascend --device npu --quantization w8a8_int8 --disaggregation-bootstrap-port 8090 --disaggregation-transfer-backend ascend
