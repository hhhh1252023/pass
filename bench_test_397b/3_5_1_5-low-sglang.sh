echo "run qwen3.5-3967B-w4a8 mtp + dp8 +  on 216"
...
#export PYTHONPATH=/home/q30063557/code/sglang-ascend/python:$PYTHONPATH
...
--model-path  /home/weights/Qwen3.5-397B-A17B-w4a8 \
--attention-backend ascend \
--device npu \
--tp-size 16 \
--chunked-prefill-size -1 --max-prefill-tokens 89000 \
--disable-radix-cache \
--trust-remote-code \
--host 127.0.0.1 --max-running-requests 256 \
--mem-fraction-static 0.85 \
--port 31125 \
--cuda-graph-bs 1 2 4 6 8 12 16 20 24 28 32 \
--quantization modelslim \
--enable-multimodal --moe-a2a-backend deepep --deepep-mode auto \
--mm-attention-backend ascend_attn \
--dtype bfloat16 --mamba-ssm-dtype bfloat16 --max-total-tokens 150000 \
