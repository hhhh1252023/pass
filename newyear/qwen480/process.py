...
tokenizer = AutoTokenizer.from_pretrained("/mnt/share/weights/Qwen3-Coder-480B-A35B-Instruct-W8A8")
...
with open(f'GSM8K-in{input_len}-bs{batch_size}_qw480.jsonl', 'w', encoding='utf-8') as f:
